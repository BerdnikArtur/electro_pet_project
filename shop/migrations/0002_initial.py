...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='product_rating', to='shop.product'),
        ),
        migrations.AddField(
            model_name='review',
            name='product_rating',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.productrating'),
        ),
        migrations.AddField(
            model_name='review',
            name='user',
